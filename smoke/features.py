...
FEATURE_INVENTORY: tuple[FeatureCoverage, ...] = (
    ...
    FeatureCoverage(
        ...
        "readme",
        ("tests/providers/test_mahbub.py",),
        (),
    ...
    FeatureCoverage(
        ...
        "public_surface",
        ("tests/api/test_dependencies.py", "tests/providers/test_ollama.py"),
        (),
    ...
    FeatureCoverage(
        ...
        product_e2e_reason="removed online/external provider endpoint",
    ),
    FeatureCoverage(
        "llamacpp_endpoint",
