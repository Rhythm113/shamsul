...
def repair_tool_arguments(name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    """Repair common small model tool call argument errors post-hoc."""
    ...
    int_keys = {"limit", "offset", "WaitMsBeforeAsync"}
    float_keys = {"timeout", "delaySeconds"}
...
def iter_heuristic_tool_use_sse(
    ...
    if isinstance(tool_input, dict) and tool_name:
        tool_use["input"] = repair_tool_arguments(tool_name, tool_input)
